...
const PAGE_URL = `${SITE_URL}/hotel-near-sharda-university`;
const WHATSAPP_URL =
  "https://wa.me/918707368307?text=Hi%2C%20I%27m%20visiting%20Sharda%20University%20and%20would%20like%20to%20enquire%20about%20a%20stay.";

const FAQS: FaqEntry[] = [
  {
    question: "How far is The Divine KRC from Sharda University?",
    answer: "Approximately 15 minutes by car via Knowledge Park II.",
  },
  {
    question: "Is the hotel suitable for families visiting patients at Sharda Hospital?",
    answer:
      "Yes — we have 24-hour front desk, room service, and all-day dining to support irregular schedules.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes — book via our website or WhatsApp for the best rate and complimentary breakfast.",
  },
];

export const Route = createFileRoute("/hotel-near-sharda-university")({
  loader: () => getRoomTypesFn(),
  head: () => ({
    meta: [
      { title: "Hotel Near Sharda University, Greater Noida | The Divine KRC" },
      {
        name: "description",
        content:
          "Boutique hotel close to Sharda University and Sharda Hospital, Knowledge Park II. Comfortable rooms for student families, medical visitors, and campus guests. Book direct.",
      },
      { property: "og:title", content: "Hotel Near Sharda University | The Divine KRC" },
      {
        property: "og:description",
        content: "A comfortable base close to Sharda University and Sharda Hospital. Book direct.",
      },
  ...
  return (
    <main className="bg-ivory text-obsidian font-sans antialiased selection:bg-gold/30 selection:text-obsidian">
      ...
      >
        <img
          src={heroExterior}
          alt="The Divine KRC boutique hotel — close to Sharda University and Sharda Hospital, Greater Noida"
          width={1536}
          height={1920}
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full px-6 md:px-10 pb-20 md:pb-28 pt-32">
          <div className="max-w-2xl space-y-6">
            <Reveal>
              <Eyebrow>Near Sharda University</Eyebrow>
            </Reveal>
            <Reveal delay={80}>
              <h1 className="font-display text-ivory text-4xl md:text-5xl lg:text-6xl leading-[1.05] text-balance">
                Your hotel near <span className="italic text-gold">Sharda University,</span> Greater
                Noida.
              </h1>
            </Reveal>
            <Reveal delay={160}>
              <p className="text-ivory/75 text-base md:text-lg font-light leading-relaxed max-w-xl">
                A practical, comfortable stay for families visiting Sharda University students,
                attending campus events, or supporting a patient at Sharda Hospital.
              </p>
            </Reveal>
            <Reveal delay={240}>
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal>
            ...
            <h2 className="font-display text-3xl md:text-4xl text-obsidian leading-[1.1] text-balance mb-10">
              Why stay with us near <span className="italic text-gold">Sharda University.</span>
            </h2>
          </Reveal>
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              {
                t: "Close to campus and hospital",
                d: "Sharda University and Sharda Hospital are both in Knowledge Park II, a short drive from the hotel. Whether you're visiting a patient or attending a campus event, you're never far.",
              },
              {
                t: "Quiet rooms after a long day",
                d: "AC rooms with proper beds and clean bathrooms. Right for families who need rest, not just a place to sleep.",
              },
              {
                t: "All-day dining on site",
                d: "Our restaurant serves from early morning through the day. Useful when hospital visits or campus schedules don't line up with standard meal times.",
              },
            ].map((item, i) => (
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal>
            ...
            <h2 className="font-display text-3xl md:text-4xl leading-[1.1] text-balance mb-4">
              Getting to Sharda University from{" "}
              <span className="italic text-gold">The Divine KRC.</span>
            </h2>
          </Reveal>
          <Reveal delay={80}>
            <p className="text-ivory/70 text-base leading-relaxed max-w-xl mb-8">
              Head toward Knowledge Park II via Omicron I. Sharda University is clearly signposted
              from the main Knowledge Park road. For patients' families with irregular visiting
              hours, our 24-hour front desk and room service are available around the clock.
            </p>
          </Reveal>
          <Reveal delay={160}>
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-ivory/80">
                ...
                By car or cab — approximately 15 minutes to Knowledge Park II
              </li>
              <li className="flex items-start gap-3 text-sm text-ivory/80">
                <span className="text-gold mt-1.5 size-1 rounded-full bg-gold shrink-0" />
                Via Omicron I toward the main Knowledge Park road
              </li>
            </ul>
          </Reveal>
        </div>
